...
*/
/*script.py*/
/*Data wykonania: 18.04.2020*/
/*Data oddania: 18.04.2020*/
*/
"""
...
def main():
    filepath = "C:/C/Programowanie klasa 3/Informatyka/Informatics/Szyfrowania/ZadDodatkowe/data.txt"
    word = getText(filepath)
    print(word)
    cols = 4
    key = [3,2,0,1]
    ...
    file = open("C:/C/Programowanie klasa 3/Informatyka/Informatics/Szyfrowania/ZadDodatkowe/result.txt" , "a" , encoding="utf-8")
